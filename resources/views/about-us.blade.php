    ...
    <div class="props bigger">
      <div class="row">
        <div class="col-md-4 col-sm-12">
          <h3><span>{{ __('about.help')}}</span><strong>108</strong><span>{{ __('about.hosts_reach')}}<br>{{ __('about.supest_host')}}</span></h3>
        </div>
        <div class="col-md-4 col-sm-12">
          <h3><span>{{ __('about.hosted')}}</span><strong>593</strong><span>{{ __('about.guest_apartments')}}<br>{{ __('about.arount_vietnam')}}</span></h3>
        </div>
        <div class="col-md-4 col-sm-12">
          <h3><span>{{ __('about.a_of_team')}}</span><strong>20</strong><span>{{ __('about.professional')}}<br> {{ __('about.airbnb_enthusiasts')}}</span></h3>
        </div>
      </div>
    </div>
  </div>
