      ...
      <div class="panel-body">
        <div class="col-md-12">
          ...
          <form id="new_full_property_management_application" 
            ...
            <div class="form-group string required full_property_management_application_name">
              <label class="control-label string required" for="full_property_management_application_name">
                <abbr title="required"></abbr> <span class="translation_missing" title="translation missing: en-uk.hosts.full_property_management_applications.new.name, current_city: London">{{ __('welcome.full_name')}}</span></label><input class="form-control string required" autofocus="autofocus" type="text" name="full_property_management_application_name" id="full_property_management_application_name" /><span class="help-block hidden">{{ __('validation.check_input')}}</span></div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <span class="translation_missing" title="translation missing: en-uk.hosts.full_property_management_applications.new.mobile_phone, current_city: London">{{ __('welcome.phone')}}</span></label>
            ...
            <div class="form-group select required full_property_management_application_city_name">
                  ...
                  <abbr title="required"></abbr> {{ __('welcome.city')}}</label><select class="form-control select required" name="full_property_management_application_city" id="full_property_management_application_city_name"><option value="">-------</option>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <abbr title="required"></abbr> {{ __('welcome.bedrooms')}}</label>
                <select class="form-control select required" name="full_property_management_application_bedrooms_count" id="full_property_management_application_bedrooms_count"><option selected="selected" value="0">------</option>
              ...
              <div class="col-md-6">
                ...
                <abbr title="required"></abbr> {{ __('welcome.bathrooms')}}</label><select class="form-control select required" name="full_property_management_application_bathrooms_count" id="full_property_management_application_bathrooms_count"><option value="0">0</option>
            ...
            <input type="submit" value="{{ __('welcome.apply')}}" class="btn btn-lg btn-block btn-primary started_click" />
        </form>        
        </div>
      </div>
    </div>
